...
/* ======================================================
   Arrow key throttle (FIX for fast keyboard navigation)
====================================================== */
function useArrowKeyThrottle(delay = 140) {
...
function SelectContent({
  ...
  const onKeyDown = useArrowKeyThrottle(140);
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        align={align}
        className={cn(
          "bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 relative z-50 max-h-[300px] min-w-[8rem] origin-[var(--radix-select-content-transform-origin)] overflow-x-hidden overflow-y-auto rounded-md border shadow-md",
          position === "popper" &&
