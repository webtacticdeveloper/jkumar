          ...
          <div className="relative max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="backdrop-blur-[2px] md:backdrop-blur-0">
              ...
              <p className="text-gray-800 md:text-gray-700 leading-relaxed text-justify text-lg mb-6">
                ...
                ourselves as one of the leading infrastructure companies in
                India. We have gained expertise in various construction
                techniques and have executed challenging projects including
                underground and elevated Metro, Irrigation Projects, Diaphragm
                walls, Tunnelling, Creek and River structures.
              </p>
